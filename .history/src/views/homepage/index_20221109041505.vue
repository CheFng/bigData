  ...
  <div class="home-container">
    <z-row :gutter="15">
      <z-col :span="7">
        ...
        <div class="echartList">
          ...
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + type + '数'">
              <city-count />
            </box-container>
          </div>
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + type + '数占比'">
              <type-count />
            </box-container>
          </div>
          <div class="chart-item">
      ...
      <z-col :span="10">
        ...
        <select v-model="types" style="width:200px;height: 30px;margin-top: 5px;margin-bottom: 5px;margin-left: 10px">
      ...
      <z-col :span="7">
        <div class="echartList">
          ...
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + type + '年龄分布'">
              <funnel-chart />
            </box-container>
          </div>
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + type + '市值'">
              <liquid-chart />
            </box-container>
          </div>
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + type + '对比'">
              <line-chart />
            </box-container>
          </div>
        </div>
