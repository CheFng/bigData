  ...
  <div class="home-container">
    <z-row :gutter="15">
      ...
      <z-col :span="10">
        ...
        <select v-model="types" placeholder="请选择查询类型" style="margin:0;height:20px; background: none;border-radius: 30px; border: 1px solid #9194a7; color: #feffff;" @change="upDateType">
