        ...
        <div class="echartList">
          <dv-decoration-7 class="btn-box">
            ...
            <button class="button" @click="change(1)">
              <dv-decoration-11 id="btn2" class="btn">信息化数据</dv-decoration-11>
            </button>
          </dv-decoration-7>
          ...
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + types + '数占比'">
              <!-- <type-count /> -->
              <shopRank style="height:calc(100% - 50px)" :rankData="rankData" />
            </box-container>
          </div>
          <div class="chart-item">
            <box-container :boxTitle="year + '年' + types + '数占比'">
        ...
        <div class="echartList">
          <dv-decoration-7 class="btn-box">
            <button class="button" @click="change(2)">
              <dv-decoration-11 id="btn1" class="btn">面积数据</dv-decoration-11>
            </button>
            <button class="button" @click="change(3)">
              <dv-decoration-11 id="btn2" class="btn">资源配置</dv-decoration-11>
            </button>
          </dv-decoration-7>
          <div class="chart-item">
...
import { getRankShopData } from "@/api/dashboard";
