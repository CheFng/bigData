  ...
  <div class="home-container">
    <z-row :gutter="15">
      ...
      <z-col :span="10">
        ...
        <select v-model="types.value" placeholder="请选择查询类型" style="margin:0;height:20px; background: none;border-radius: 30px; border: 1px solid #2885c0; color: #2885c0;" @change="upDateType(value)">
