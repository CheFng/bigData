...
import { selectCityData } from "@/api/mockChart";

export default {
  name: "cityCount",
  setup() {
    let { abcode, year, types, parentInfo, routerChange } = useResize();
      ...
      myChart.setOption(
        {
          ...
          tooltip: {
            ...
            formatter: (params) => {
              return params[0].name + "<br>"+ types.value +"数：" + params[0].value + "万";
            },
          },
          toolbox: {
            feature: {
              ...
              saveAsImage: {
                show: true,
                name: year.value + "年"+ types.value +"数排名",
                pixelRatio: 2,
              },
            },
            iconStyle: {
