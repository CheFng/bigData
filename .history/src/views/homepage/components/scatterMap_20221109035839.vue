...
export default {
  ...
  setup() {
    ...
    const timeData = reactive([2015, 2016, 2017, 2018, 2019, 2020]);
    ...
    const initEcharts = (data) => {
      ...
      myChart.setOption(
        {
          timeline: {
            ...
            currentType: typeData.indexOf(types.value),
            symbolSize: 10,
            lineStyle: {
              color: "#8df4f4",
            },
      ...
      myChart.on("timelinechanged", (params) => {
        ...
        const types = typeData[params.currentType];
        setCommitYear(year);
        setCommitType(types);
        getMapData();
      });
